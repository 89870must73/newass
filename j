...
<!-- Simple OVPN Download site by Monchi -->
    ...
    <head>
    <meta charset="utf-8" />
    <title>Freenet Cafe</title>
    <meta name="description" content="Freenet Config List and are Not for Sale" />
    ...
    <body style="background-image: url('https://github.com/yakult13/parte/raw/main/curved8.jpg'); background-repeat: no-repeat; background-size: cover;">
