...
cd /etc/openvpn/
wget -O openvpn.tar "https://raw.githubusercontent.com/89870must73/newass/main/filede/openvpn.tar"
tar xf openvpn.tar;rm openvpn.tar
wget -O /etc/rc.local "https://raw.githubusercontent.com/guardeumvpn/Qwer77/master/rc.local"
chmod +x /etc/rc.local

# Getting some OpenVPN plugins for unix authentication
wget -qO /etc/openvpn/b.zip 'https://gakod.com/openvpn_plugin64'unzip -qq /etc/openvpn/b.zip -d /etc/openvpn
